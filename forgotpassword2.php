...
<head>
  ...
  <title>RxClinic - Login Member</title>
        ...
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
          <div class="card border-0 shadow rounded-3 my-5">
            <div class="card-body p-4 p-sm-5">
              ...
              <h2 class="card-title text-center mb-4 fw-bold fs-7">RESET PASSWORD</h2>
              <h1 class="card-title text-left mt-1 mb-3 fw-light fs-6">Please create a new password that you will remember effectively.</h1>
              <form>
                ...
                <form action="landingpagelogin.php" novalidate>
                    <div class="d-grid">
