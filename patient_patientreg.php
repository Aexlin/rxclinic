...
<head>
    ...
    <title>Register - Rx Clinic</title><!-- Prevent the demo from appearing in search engines -->
                    ...
                    <div class="mdk-header__content">
                        <div class="navbar navbar-expand-sm navbar-main navbar-light bg-white  pr-0" id="navbar" data-primary>
                            <div class="container-fluid p-0">
                                <!-- Navbar toggler --><button class="navbar-toggler navbar-toggler-custom d-lg-none d-flex mr-navbar" type="button" data-toggle="sidebar"><span class="material-icons">short_text</span></button><!-- Navbar Brand --><a href="#" class="navbar-brand flex "><span>Register</a>
                                <div>
                                ...
                                <div class="col-lg-8 card-form__body card-body bg-white">
                                    <div class="modal-body">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="patient_index.php"><button type="button" class="btn btn-dark">Register
                                            </button></a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="mdk-drawer__content">
                <div class="sidebar sidebar-dark sidebar-left simplebar" data-simplebar>
                    ...
                    <div class="mt-auto sidebar-p-a sidebar-b-t d-flex flex-column flex-shrink-0">
                        <a class="sidebar-link mb-2" href="#">Register<i class="sidebar-menu-icon ml-2 material-icons icon-16pt">person</i></a>
