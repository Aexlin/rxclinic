...
<head>
    ...
    <title>Change Password - Rx Clinic</title><!-- Prevent the demo from appearing in search engines -->
                        ...
                        <div class="navbar navbar-expand-sm navbar-main navbar-light bg-white  pr-0" id="navbar"
                            ...
                            <div class="container-fluid p-0">
                                <!-- Navbar toggler --><button
                                    ...
                                    href="#" class="navbar-brand flex "><span>Change Password</span></a>
                        ...
                        <div class="card card-form">
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-8 card-form__body card-body">
                                    <div class="form-group"><label for="opass">Old Password</label><input
                                            style="width: 300px;" id="opass" type="password" class="form-control"
                                    ...
                                    <div class="form-group"><label for="cpass">New Password</label><input
                                            style="width: 300px;" id="cpass" type="password" class="form-control"
                                            placeholder="New password"></div>
                                    <div class="form-group"><label for="cpass">Confirm Password</label><input
                                            style="width: 300px;" id="cpass" type="password" class="form-control"
                                            placeholder="Confirm password"></div>
                                    <div class="modal-footer"><a href="doctor_myprofile.php"><button type="button" class="btn btn-light"
                                        data-dismiss="modal">Cancel</button></a><button type="button" class="btn btn-primary"
                                        data-toggle="modal" data-target="#modal-success">Save Changes</button></div>
                                </div>
                            </div>
                        </div>
                    </div>
