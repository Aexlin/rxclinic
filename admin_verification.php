...
<head>
    ...
    <title>Doctor Verification - Rx Clinic</title><!-- Prevent the demo from appearing in search engines -->
                    ...
                    <div class="mdk-header__content">
                        <div class="navbar navbar-expand-sm navbar-main navbar-light bg-white  pr-0" id="navbar" data-primary>
                            <div class="container-fluid p-0">
                                <!-- Navbar toggler --><button class="navbar-toggler navbar-toggler-custom d-lg-none d-flex mr-navbar" type="button" data-toggle="sidebar"><span class="material-icons">short_text</span></button><!-- Navbar Brand --><a href="index.php" class="navbar-brand flex "><span>Doctor Verification</span></a>
                            ...
                            <div class="card">
                                <div class="tab-content">
                                    <div class="tab-pane active show fade" id="tab-queue">
                                        <div class="table-responsive border-bottom" data-toggle="lists" data-lists-values='["js-lists-values-employee-name", "js-lists-values-employee-title", "js-lists-values-employee-date", "js-lists-values-employee-specialization"]'>
                                            <div class="search-form search-form--light m-3"><input type="text" class="form-control search" placeholder="Search Doctor ID, Name or Specialization"><button class="btn" type="button" role="button"><i class="material-icons">search</i></button></div>
                                            <table class="table mb-0 thead-border-top-0">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 300px;">
                                                            <a href="javascript:void(0)" class="sort" data-sort="js-lists-values-employee-title">Doctor
                                                                ID.</a>
                                                        </th>
                                                        <th style="width: 300px;">
                                                            <a href="javascript:void(0)" class="sort" data-sort="js-lists-values-employee-name">Doctor Name
                                                                Name</a>
                                                        </th>
                                                        <th style="width: 250px;">
                                                            <a href="javascript:void(0)" class="sort" data-sort="js-lists-values-employee-specialization">Specialization
                                                            </a>
                                                        </th>
                                                ...
                                                <tbody class="list" id="staff02">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="js-lists-values-employee-specialization">Cardiology</span></td>
                                                        <td>
                                                            <div class="button-list">
                                                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-success"><i class="material-icons">check</i></button>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="media align-items-center">
                                                                ...
                                                                <div class="media-body d-flex flex-column"><strong class="js-lists-values-employee-name">Ariana Batumbakal</strong></div>
                                                            </div>
                                                        </td>
                                                        <td><span class="js-lists-values-employee-specialization">Otolaryngology</span></td>
                                                        <td>
                                                            <div class="button-list">
                                                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-success"><i class="material-icons">check</i></button>
                                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-delete"><i class="material-icons">cancel</i></button>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="media align-items-center">
                                                                ...
                                                                <div class="media-body d-flex flex-column"><strong class="js-lists-values-employee-name">Joaquin Barumbado</strong></div>
                                                            </div>
                                                        </td>
                                                        <td><span class="js-lists-values-employee-specialization">Family Medicine</span></td>
                                                        <td>
                                                            <div class="button-list">
                                                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-success"><i class="material-icons">check</i></button>
                                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-delete"><i class="material-icons">cancel</i></button>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="js-lists-values-employee-specialization">General Dentistry</span></td>
                                                        <td>
                                                            <div class="button-list">
                                                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-success"><i class="material-icons">check</i></button>
                                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-delete"><i class="material-icons">cancel</i></button>
                                                    ...
                                                    <tr>
                                                        <td><span class="badge d-block badge-soft-primary"><strong class="js-lists-values-employee-title">2022-0021</strong></span>
                                                        </td>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="avatar avatar-xs mr-2"><img src="assets/images/profilem.png" alt="Avatar" class="avatar-img rounded-circle">
                                                                </div>
                                                                <div class="media-body d-flex flex-column"><strong class="js-lists-values-employee-name">Maria Clara</strong></div>
                                                            </div>
                                                        </td>
                                                        <td><span class="js-lists-values-employee-specialization">Cardiology</span></td>
                                                        <td>
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content bg-success">
                    <div class="modal-body text-center p-4"><i class="material-icons icon-40pt text-white mb-2">check</i>
                        ...
                        <p class="text-white mt-3">You verified a doctor.</p><button type="button" class="btn btn-light my-2" data-dismiss="modal">Continue</button>
                    </div><!-- // END .modal-body -->
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content bg-danger">
                    <div class="modal-body text-center p-4"><i class="material-icons icon-40pt text-white mb-2">cancel</i>
                        <h4 class="text-white">Denied!</h4>
                        <p class="text-white mt-3">You denied a doctor.</p><button type="button" class="btn btn-light my-2" data-dismiss="modal">Continue</button>
                    </div><!-- // END .modal-body -->
                </div><!-- // END .modal-content -->
            </div><!-- // END .modal-dialog -->
        </div><!-- // END .modal -->
        ...
        <div class="mdk-drawer  js-mdk-drawer" id="default-drawer" data-align="start">
            <div class="mdk-drawer__content">
                <div class="sidebar sidebar-dark sidebar-left simplebar" data-simplebar>
                    <div class="d-flex align-items-center sidebar-p-a border-bottom sidebar-account flex-shrink-0"><a href="admin_index.php" class="flex d-flex align-items-center text-underline-0 text-body"><span class="mr-3"><img src="assets/img/rxcliniclogowithoutline.png" width="43" height="43" alt="avatar"></span><span class="flex d-flex flex-column"><strong style="font-size: 25px;">Rx Cinic</strong><small class="text-muted text-uppercase" style="color: rgba(255,255,255,.54)"></small></span></a>
                    ...
                    <div class="mt-auto sidebar-p-a sidebar-b-t d-flex flex-column flex-shrink-0">
                        <a class="sidebar-link mb-2" href="#">Doctor Verification<i class="sidebar-menu-icon ml-2 material-icons icon-16pt">check_circle</i></a>
