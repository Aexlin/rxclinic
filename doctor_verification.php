                        ...
                        <div class="navbar navbar-expand-sm navbar-main navbar-light bg-white  pr-0" id="navbar"
                            ...
                            <div class="container-fluid p-0">
                                <!-- Navbar toggler --><button
                                    ...
                                    href="#" class="navbar-brand flex "><span>Doctor Verification</span></a>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active show fade" id="tab-queue">
                                        <div class="table-responsive border-bottom" data-toggle="lists"
                                            data-lists-values='["js-lists-values-employee-name", "js-lists-values-employee-title", "js-lists-values-employee-date", "js-lists-values-employee-specialization"]'>
                                            <div class="search-form search-form--light m-3"><input type="text"
                                                    class="form-control search"
                                                    placeholder="Search Doctor ID, Name or Specialization"><button class="btn"
                                            ...
                                            <table class="table mb-0 thead-border-top-0">
                                                    ...
                                                    <tr>
                                                        <th style="width: 300px;">
                                                            <a href="javascript:void(0)" class="sort"
                                                                data-sort="js-lists-values-employee-title">Doctor
                                                                ID.</a>
                                                        </th>
                                                        <th style="width: 300px;">
                                                            <a href="javascript:void(0)" class="sort"
                                                                data-sort="js-lists-values-employee-name">Doctor Name
                                                                Name</a>
                                                        </th>
                                                        <th style="width: 250px;">
                                                            <a href="javascript:void(0)" class="sort"
                                                                data-sort="js-lists-values-employee-specialization">Specialization
                                                                </a>
                                                        </th>
                                                ...
                                                <tbody class="list" id="staff02">
                                                        ...
                                                        <td>
                                                            <div class="media align-items-center">
                                                                ...
                                                                <div class="media-body d-flex flex-column"><strong
                                                                        class="js-lists-values-employee-name">Juan Dela
                                                                        Cruz</strong></div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td><span class="badge d-block badge-soft-primary"><strong
                                                                    class="js-lists-values-employee-title">2022-0018</strong></span>
                                                        </td>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="avatar avatar-xs mr-2"><img
                                                                ...
                                                                <div class="media-body d-flex flex-column"><strong
                                                                        class="js-lists-values-employee-name">Ariana Batumbakal</strong></div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td><span class="badge d-block badge-soft-primary"><strong
                                                                    class="js-lists-values-employee-title">2022-0019</strong></span>
                                                        </td>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="avatar avatar-xs mr-2"><img
                                                                ...
                                                                <div class="media-body d-flex flex-column"><strong
                                                                        class="js-lists-values-employee-name">Joaquin Barumbado</strong></div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td><span class="badge d-block badge-soft-primary"><strong
                                                                    class="js-lists-values-employee-title">2022-0020</strong></span>
                                                        </td>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="avatar avatar-xs mr-2"><img
                                                    ...
                                                    <tr>
                                                        <td><span class="badge d-block badge-soft-primary"><strong
                                                                    class="js-lists-values-employee-title">2022-0021</strong></span>
                                                        </td>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="avatar avatar-xs mr-2"><img
                                                                ...
                                                                <div class="media-body d-flex flex-column"><strong
                                                                        class="js-lists-values-employee-name">Maria Clara</strong></div>
                                                            </div>
                                                        </td>
                                                        <td><span class="js-lists-values-employee-specialization">Cardiology</span></td>
                                                        <td>
                                        ...
                                        <div class="card-body text-right">Showing 5 <span class="text-muted">of
                                                23</span><a href="#" class="text-muted-light"><i
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content bg-success">
                    <div class="modal-body text-center p-4"><i
                        ...
                        <p class="text-white mt-3">You verified a doctor.</p><button type="button"
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content bg-danger">
                    <div class="modal-body text-center p-4"><i
                        ...
                        <p class="text-white mt-3">You denied a doctor.</p><button type="button"
                            class="btn btn-light my-2" data-dismiss="modal">Continue</button>
                    </div><!-- // END .modal-body -->
                </div><!-- // END .modal-content -->
            </div><!-- // END .modal-dialog -->
            ...
            <div class="mdk-drawer__content">
                <div class="sidebar sidebar-dark sidebar-left simplebar" data-simplebar>
                        ...
                        <div id="sm-menu" class="tab-pane show active" role="tabpanel" aria-labelledby="sm-menu-tab">
                            <ul class="sidebar-menu flex">
                                ...
                                <li class="sidebar-menu-item"><a class="sidebar-menu-button" href="doctor_consultations.php"><i
                                 ...
                                 <li class="sidebar-menu-item"><a class="sidebar-menu-button" href="#"><i
                                ...
                                <li class="sidebar-menu-item"><a class="sidebar-menu-button" href="doctor_prescriptions.php"><i
                                            ...
                                            class="sidebar-menu-text">Prescriptions</span></a></li>
                    ...
                    <div class="mt-auto sidebar-p-a sidebar-b-t d-flex flex-column flex-shrink-0">
                            <a class="sidebar-link mb-2" href="#">Doctor Verification<i
