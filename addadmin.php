    ...
    <header id="header" class="header fixed-top">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
          ...
          <li><a class="nav-link scrollto" href="#contact">CONTACT</a></li> -->
                    ...
                    <li><a class="getstarted scrollto" href="landingpage.php">LOG OUT</a></li>
                    <!-- <li><a class="getstarted scrollto" href="landingpage.php"><i
                                class="bi bi-person-plus-fill"></i>&nbsp;ADD ADMIN</a></li> -->
                </ul>
                ...
                <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                    <div class="card border-0 shadow rounded-3 my-5">
                        <div class="card-body p-4 p-sm-5">
                            ...
                            <h2 class="card-title text-center mb-4 fw-bold fs-7"><i class="bi bi-person-plus-fill"></i>
                                ADD ADMIN</h2>
                  ...
                  <script src="https://www.google.com/recaptcha/api.js"></script>
                            ...
                            <div class="d-grid">
                                <button class="btn btn-primary btn-login text-uppercase fw-bold" type="submit">Add Admin
                                </button>
                            </div>
                            <!-- <br>
