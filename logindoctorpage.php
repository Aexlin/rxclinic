...
<head>
  ...
  <title>RxClinic - Login Doctor</title>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="getstarted scrollto" href="registerdoctor.php">REGISTER as DOCTOR</a></li>
        ...
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
          <div class="card border-0 shadow rounded-3 my-5">
            <div class="card-body p-4 p-sm-5">
              ...
              <h2 class="card-title text-center mb-4 fw-bold fs-7">LOGIN as DOCTOR</h2>
              ...
              <form>
                ...
                <!-- <div class="text-center">
                  <p>Not a member? <a href="registerdoctor.php">Register as Doctor</a></p>
                </div> -->
<!-- 
                <hr class="my-4">
