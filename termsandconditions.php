...
<head>
    ...
    <title>Terms and Conditions - RxClinic</title>
                ...
                <div class="col-sm-9 col-md-7 col-lg-12 mx-auto">
                    <div class="card border-0 shadow rounded-3 my-5">
                        <div class="card-body p-4 p-sm-5">
                            ...
                            <h2 class="card-title text-left mb-2 fw-bold fs-5 text-center">TERMS and CONDITIONS</h2>
                            <form>
                                <h1 class="card-title text-left mt-1 mb-3 fs-6"><strong>Table of Contents</strong></h1>
                                <h1 class="card-title text-left mt-1 mb-3 fw-light fs-6"><strong>1. AGREEMENT TO
                                        TERMS<br>
                                ...
                                <h1 class="card-title text-left mt-1 mb-3 fs-6"><strong>1. AGREEMENT TO TERMS</strong>
                                </h1>
                                <p>
                                    These Terms of Use constitute a legally binding agreement made between you, whether
                                    personally or on behalf of an entity ("you") and Hospital Management System
                                    ("Company "we," "us," or "our"), concerning your access to and use of the website as
                                    ...
                                    time to
                                    times are hereby expressly incorporated herein by reference. We reserve the right,
                                    in our sole
                                    discretion, to make changes or modifications to these Terms of Use at any time and
                                    for any reason. We will alert you about any changes by updating the "Last updated"
                                    date of these Terms
                                    ...
                                    understand which
                                    Terms apply. You will be subject to, and will be deemed to have been made aware of
                                    and to
                                    have accepted, the changes in any revised Terms of Use by your continued use of the
                                    Site after
                                    the date such revised Terms of Use are posted. <br><br>
                                    ...
                                    with local laws if and to the extent local laws are applicable. <br><br>
                                    ...
                                    permission of,
                                    and be directly supervised by their parents or guardian to use the Site. If you are
                                    a minor, you
                                    must have your parent or guardian read and agree to these Terms of Use prior to you
                                    using the
                                    Site.

                                </p>
                                <br><br>
                                <h1 class="card-title text-left mt-1 mb-3 fs-6"><strong>2. INTELLECTUAL PROPERTY
                                        RIGHTS</strong>
                                </h1>
                                <p>
                                    ...
                                    contained therein
                                    (the "Marks") are owned or controlled by us or licensed to us, and are protected by
                                    ...
                                    international conventions. The Content and the Marks are provided on the Site "AS
                                    IS" for your information and personal use only. Except as expressly provided in
                                    ...
                                    access and
                                    use the Site and to download or print a copy of any portion of the Content to which
                                    you have
                                    properly gained access solely for your personal, non-commercial use. We reserve all
                                    rights not
                                    expressly granted to you in and to the Site, the Content and the Marks. <br><br>
                                </p><br>
                                <h1 class="card-title text-left mt-1 mb-3 fs-6"><strong>3. USER REPRESENTATIONS
                                    </strong>
                                </h1>
                                <p>
                                    ...
                                    information
                                    and promptly update such registration information as necessary: (3) you have the
                                    legal capacity and you agree to comply with these Terms of Use: (4) you are not
                                    under the age of 13; (5) YOU are not a minor in the jurisdiction in which you
                                    reside, or if a mingi you have received parental permission to use the Site; (6) you
                                    ...
                                    unauthorized purpose; and (8) your use of the Site will not violate any applicable
                                ...
                                <h1 class="card-title text-left mt-1 mb-3 fs-6"><strong>4. USER REGISTRATION
                                    </strong>
                                </h1>
                                <p>
                                ...
                                <h1 class="card-title text-left mt-1 mb-3 fs-6"><strong>5. PROHIBITED ACTIVITIES
                                    </strong>
                                </h1>
                                <p>You may not access or use the Site for any purpose other than that for which we make
                                    the Site
                                    ...
                                    <li>
                                        ...
                                        directory without written permission from the US.
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        Harass, annoy, irritate or threaten any of our employees or agents engaged in
                                ...
                                <h1 class="card-title text-left mt-1 mb-3 fs-6"><strong>6. CONTRIBUTION LICENSE
                                    </strong>
                                </h1>
                                <p>
                                    ...
                                    non-exclusive transferable, royalty-free, fully- paid, worldwide fight, and license
                                    ...
                                    advertising, or otherwise, and to
                                    ...
                                    against us regarding your Contributions.<br><br>
                                    ...
                                    appropriate
                                    locations on the Site; and (3) to pre-screen or delete any Contributions at any time
                                    and for any
                                    reason, without notice. We have no obligation to monitor your Contributions.<br><br>

                                </p><br>
                                <h1 class="card-title text-left mt-1 mb-3 fs-6"><strong>7. SOCIAL MEDIA
                                    </strong>
                                </h1>
                                <p>
                                    ...
                                    is terminated by the third-party service provider, the Social Network Content may no
                                    longer be available on and through the Site. You will have the ability to disable
                                ...
                                <br>
                                <h1 class="card-title text-left mt-1 mb-3 fs-6"><strong>8. SUBMISSIONS
                                    </strong>
                                </h1>
                                <p>
                                    You acknowledge and agree that any questions, comments, suggestions, ideas,
                                    feedback, orother information regarding the Site ("Submissions”) provided by you to
                                ...
                                <br>
                                <h1 class="card-title text-left mt-1 mb-3 fs-6"><strong>9. SITE MANAGEMENT
                                    </strong>
                                </h1>
                                <p>
                                    ...
                                    Contríbutions or any portion thereof, (4) in our sole discretion and without
                                ...
                                <br>
                                <h1 class="card-title text-left mt-1 mb-3 fs-6"><strong>10. PRIVACY POLICY
                                    </strong>
                                </h1>
                                <p>
                                    We care about data privacy and security. By using the Site, you agree to be bound by
                                    ourPrivacy Policy posted on the Site,which is incorporated into these Terms of
                                    Use.Please be advised the Site is hosted in ______ If you access the Site from any
                                    other region of the world with laws or other requirements governing personal data
                                    collection use, or disclosure that differ from applicable laws in ______ then
                                    through your continued use of the Site, you are transferring your data to and you
                                    agree to have your data transferred to and processed in ________.
