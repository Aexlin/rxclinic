...
<head>
    ...
    <title>Records - Rx Clinic</title><!-- Prevent the demo from appearing in search engines -->
                        ...
                        <div class="navbar navbar-expand-sm navbar-main navbar-light bg-white  pr-0" id="navbar"
                            ...
                            <div class="container-fluid p-0">
                                <!-- Navbar toggler --><button
                                    ...
                                    href="index.php" class="navbar-brand flex "><span>Patients</span></a>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active show fade" id="tab-queue">
                                        <div class="table-responsive border-bottom" data-toggle="lists"
                                            data-lists-values='["js-lists-values-employee-name", "js-lists-values-employee-title", "js-lists-values-employee-service", "js-lists-values-employee-doctor"]'>
                                            <div class="search-form search-form--light m-3"><input type="text"
                                                    class="form-control search"
                                                    placeholder="Search Student Patient ID, Name or Service"><button
                                            ...
                                            <table class="table mb-0 thead-border-top-0">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width: 150px;">
                                                            <a href="javascript:void(0)" class="sort"
                                                                data-sort="js-lists-values-employee-service">Service</a>
                                                        </th>
                                                        <th style="width: 150px;">
                                                            <a href="javascript:void(0)" class="sort"
                                                                data-sort="js-lists-values-employee-doctor">Doctor</a>
                                                        </th>
                                                        <th style="width: 120px;">Medicine</th>
                                                ...
                                                <tbody class="list" id="staff02">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span
                                                                class="js-lists-values-employee-service">Cardiology</span>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="media align-items-center">
                                                                ...
                                                                <div class="media-body d-flex flex-column"><strong
                                                                        class="js-lists-values-employee-name">Maria
                                                                        Clara</strong></div>
                                                            </div>
                                                        </td>
                                                        <td><span
                                                                class="js-lists-values-employee-service">Otolaryngology</span>
                                                        </td>
                                                        <td><span class="js-lists-values-employee-doctor">Dr. Number
                                                                Too</span></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="media align-items-center">
                                                                ...
                                                                <div class="media-body d-flex flex-column"><strong
                                                                        class="js-lists-values-employee-name">Crisostomo
                                                                        Ibarra</strong></div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="avatar avatar-xs mr-2"><img
                                                                        src="assets/images/steve.png" alt="Avatar"
                                                                        class="avatar-img rounded-circle">
                                                                </div>
                                                                <div class="media-body d-flex flex-column"><strong
                                                                        class="js-lists-values-employee-name">Steve
                                                                        Harrington</strong></div>
                                                            </div>
                                                        </td>
                                                        <td><span
                                                                class="js-lists-values-employee-service">Gastroenterology</span>
                                                        </td>
                                                        <td><span class="js-lists-values-employee-doctor">Dr. Number
                                                                Too</span></td>
                                                        <td>Colgate Toothpaste</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="media align-items-center">
                                                                ...
                                                                <div class="media-body d-flex flex-column"><strong
                                                                        class="js-lists-values-employee-name">Eleven
                                                                        Hopper</strong></div>
                                                            </div>
                                                        </td>
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content bg-danger">
                    <div class="modal-body text-center p-4"><i
                        ...
                        <p class="text-white mt-3">You deleted a report.</p><button type="button"
                            class="btn btn-light my-2" data-dismiss="modal">Continue</button>
                    </div><!-- // END .modal-body -->
                </div><!-- // END .modal-content -->
            </div><!-- // END .modal-dialog -->
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group"><label class="text-label" for="fname">Patient
                                                ID:</label><input id="fname" type="text" required=""
                                                class="form-control" placeholder="Patient ID" value="2022-0016"></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group"><label class="text-label" for="fname">First
                                                ...
                                                class="form-control" placeholder="First name" value="Juan"></div>
                                    </div>
                                    <div class="col">
                                    ...
                                    <div class="col">
                                        <div class="form-group"><label class="text-label" for="lname">Last
                                                ...
                                                class="form-control" placeholder="Last name" value="Dela Cruz"></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group"><label class="text-label" for="fname">Email
                                                ...
                                                value="jdlc_pupqc@gmail.com"></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group"><label class="text-label" for="fname">Contact
                                                ...
                                                class="form-control" placeholder="Contact No." value="09987654321">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group"><label class="text-label"
                                                for="lname">Username:</label><input id="lname" type="text"
                                                class="form-control" placeholder="@username" value="@juandelacruz">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group"><label class="text-label"
                                            ...
                                            <div class="input-group input-group-merge"><input id="password_2"
                                                    type="text" required="" class="form-control form-control-prepended"
                                                    placeholder="Enter your password" value="jdlcpassword">
