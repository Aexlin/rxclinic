...
<head>
    ...
    <title>Patients - Rx Clinic</title><!-- Prevent the demo from appearing in search engines -->
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active show fade" id="tab-queue">
                                        <div class="table-responsive border-bottom" data-toggle="lists"
                                            data-lists-values='["js-lists-values-employee-name", "js-lists-values-employee-title", "js-lists-values-employee-date"]'>
                                            ...
                                            <table class="table mb-0 thead-border-top-0">
                                                ...
                                                <tbody class="list" id="staff02">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>ci_pupqc@gmail.com</td>
                                                        <td>09828231197</td>
                                                        <td>@crisostomoibarra</td>
                                                        <td>cipassword</td>
                                                        <td><span class="badge badge-success">ACTIVE</span></td>
                                                        <td>
                                                            <div class="button-list">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>sh_pupqc@gmail.com</td>
                                                        <td>09478892563</td>
                                                        <td>@steveharrington</td>
                                                        <td>shpassword</td>
                                                        <td><span class="badge badge-success">ACTIVE</span></td>
                                                        <td>
                                                            <div class="button-list">
                    ...
                    <div class="d-flex align-items-center sidebar-p-a border-bottom sidebar-account flex-shrink-0"><a
                            href="admin_index.php" class="flex d-flex align-items-center text-underline-0 text-body"><span
                                class="mr-3"><img src="assets/img/rxcliniclogowithoutline.png" width="43" height="43"
                                    ...
                                    style="font-size: 25px;">Rx Cinic</strong><small class="text-muted text-uppercase"
