                                ...
                                <div class="card card-body">
                                    <form action="#" novalidate>
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-group text-center"><a href="patient_editprofile.php"><button type="button" class="btn btn-primary-dark" data-toggle="modal"
                                                    data-target="#modal-success">Edit Profile</button></a></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group text-center"><a href="patient_changepassword.php"><button type="button" class="btn btn-primary-dark" data-toggle="modal"
