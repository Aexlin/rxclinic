...
<head>
    ...
    <title>Book New Consultation - Rx Clinic</title><!-- Prevent the demo from appearing in search engines -->
                    ...
                    <div class="container-fluid page__container">
                        <div class="card card-body">
                            <div
                                ...
                                <a href="index.php" class="navbar-brand text-center mb-2 mr-0"
                                    style="min-width: 0"><img class="navbar-brand-icon"
                                        src="assets/img/rxlogowithname.png" width="320"
                            ...
                            <form action="index.php" novalidate>
                                ...
                                <div class="modal-footer"><a href="patient_consultations.php"><button type="button" class="btn btn-light"
                                    data-dismiss="modal">Cancel</button></a><a href="#"><button type="button" class="btn btn-dark"
                                    data-toggle="modal"
                                    data-target="#modal-success">Submit</button></a></div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content bg-success">
                    <div class="modal-body text-center p-4"><i
                        ...
                        <h4 class="text-white">Appointment Requested!</h4>
                        <p class="text-white mt-3">Your appointment has been submitted.</p><a href="index_patient.php"><button type="button"
                            class="btn btn-light my-2" data-dismiss="modal">Continue</button></a>
                    </div><!-- // END .modal-body -->
