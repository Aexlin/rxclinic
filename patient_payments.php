...
<head>
    ...
    <title>Payments - Rx Clinic</title><!-- Prevent the demo from appearing in search engines -->
                        ...
                        <div class="navbar navbar-expand-sm navbar-main navbar-light bg-white  pr-0" id="navbar"
                            ...
                            <div class="container-fluid p-0">
                                <!-- Navbar toggler --><button
                                    ...
                                    href="#" class="navbar-brand flex "><span>Payments</span></a>
                                <div>
                                    ...
                                    <div class="tab-pane active show fade" id="tab-queue">
                                        <div class="table-responsive border-bottom" data-toggle="lists"
                                            ...
                                            <div class="search-form search-form--light m-3"><input type="text"
                                                    ...
                                                    placeholder="Search Invoice ID, Amount or Doctor"><button class="btn"
