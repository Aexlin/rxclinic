...
<head>
    ...
    <title>Rx Clinic</title><!-- Prevent the demo from appearing in search engines -->
                    ...
                    <div class="container-fluid page__container">
                        <div class="card card-body">
                            ...
                            <form action="index.php" novalidate>
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group"><label class="text-label" for="name">Name:</label><input id="fname" type="text" class="form-control" placeholder="" value="Rx Clinic"></div>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="form-group"><label class="text-label" for="address">Address:</label><input id="lname" type="text" class="form-control" placeholder="" value="Don Fabian St., Brgy. Commonwealth, Quezon City"></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group"><label class="text-label" for="emailadd">Email
                                                Address:</label><input id="fname" type="text" class="form-control" placeholder="" value="rxclinic@gmail.com"></div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group"><label class="text-label" for="contact">Contact:</label><input id="lname" type="text" class="form-control" placeholder="" value="0998-765-4321"></div>
                                    </div>
                                </div>
                                <div>
                                    <button type="button" class="btn btn-primary-dark" data-toggle="modal" data-target="#modal-success">Edit Clinic Details</button>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-center-title"><img class="navbar-brand-icon" src="assets/img/rxcliniclogowithoutline.png" width="50" alt="Stack"><strong>Edit Clinic
                            Details</strong></h5>
                ...
                <div class="modal-body">
                    <div class="px-3">
                        ...
                        <form action="#">
                            <div class="row">
                                <div class="col">
                                    <div class="form-group"><label class="text-label" for="fname">
                                            Name:</label><input id="fname" type="text" required="" class="form-control" placeholder="First name" value="Rx Clinic"></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group"><label class="text-label" for="fname">
                                            Address:</label><input id="fname" type="text" required="" class="form-control" placeholder="name@gmail.com" value="Don Fabian St., Brgy. Commonwealth, Quezon City"></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group"><label class="text-label" for="fname">Email
                                            Address:</label><input id="fname" type="text" required="" class="form-control" placeholder="name@gmail.com" value="dentalzone_pupqc@gmail.com"></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
