                        ...
                        <div class="navbar navbar-expand-sm navbar-main navbar-light bg-white  pr-0" id="navbar"
                            ...
                            <div class="container-fluid p-0">
                                <!-- Navbar toggler --><button
                                    ...
                                    href="index.php" class="navbar-brand flex "><span>Prescriptions</span></a>
                                <!-- <div>
                                    ...
                                    <div class="tab-pane active show fade" id="tab-queue">
                                        <div class="table-responsive border-bottom" data-toggle="lists"
                                            ...
                                            <div class="search-form search-form--light m-3"><input type="text"
                                                    ...
                                                    placeholder="Search Prescription Code, Name or Date"><button
                                            ...
                                            <table class="table mb-0 thead-border-top-0">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th colspan="1" style="width: 200px;">
                                                            <a href="javascript:void(0)" class="sort"
                                                                data-sort="js-lists-values-employee-doctor">Doctor
                                                            </a>
                                                        </th>
                                                ...
                                                <tbody class="list" id="staff02">
                                                    ...
                                                    <tr>
                                                        <td><span class="badge d-block badge-soft-primary"><strong
                                                                    class="js-lists-values-employee-title">PR-2022-0708-0001</strong></span>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td><span
                                                                class="js-lists-values-employee-service">07/08/22</span>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td><span class="badge d-block badge-soft-primary"><strong
                                                                    class="js-lists-values-employee-title">PR-2022-0709-0002</strong></span>
                                                        </td>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="avatar avatar-xs mr-2"><img
                                                        ...
                                                        <td><span
                                                                class="js-lists-values-employee-service">09/07/22</span>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td><span class="badge d-block badge-soft-primary"><strong
                                                                    class="js-lists-values-employee-title">PR-2022-0710-0003</strong></span>
                                                        </td>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="avatar avatar-xs mr-2"><img
                                                        ...
                                                        <td><span
                                                                class="js-lists-values-employee-service">10/07/22</span>
                                                        </td>
                                                        <td>ibuprofen (Motrin® or Advil®)</td>
                                                        <td>400–600 mg</td>
                                                        <td>Take 400–600 mg every 6–8 hours. Ibuprofen will help with
                                                    ...
                                                    <tr>
                                                        <td><span class="badge d-block badge-soft-primary"><strong
                                                                    class="js-lists-values-employee-title">PR-2022-0711-0004</strong></span>
                                                        </td>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="avatar avatar-xs mr-2"><img
                                                        ...
                                                        <td><span
                                                                class="js-lists-values-employee-service">11/07/22</span>
                                                        </td>
                                                        <td>Colgate Toothpaste</td>
                                                        <td>Any type of gram</td>
                                                        <td>Brush your teeth using this toothpaste after every meal (3).
                                                    ...
                                                    <tr>
                                                        <td><span class="badge d-block badge-soft-primary"><strong
                                                                    class="js-lists-values-employee-title">PR-2022-0712-0005</strong></span>
                                                        </td>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="avatar avatar-xs mr-2"><img
                                                        ...
                                                        <td><span
                                                                class="js-lists-values-employee-service">12/07/22</span>
                                                        </td>
                                                        <td>ibuprofen (Motrin® or Advil®)</td>
                                                        <td>400–600 mg</td>
                                                        <td>Take 400–600 mg every 6–8 hours. Ibuprofen will help with
