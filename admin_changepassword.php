                        ...
                        <div class="navbar navbar-expand-sm navbar-main navbar-light bg-white  pr-0" id="navbar"
                            ...
                            <div class="container-fluid p-0">
                                <!-- Navbar toggler --><button
                                    ...
                                    href="index.php" class="navbar-brand flex "><span>Change Password</span></a>
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-8 card-form__body card-body">
                                    ...
                                    <div class="modal-footer"><a href="myprofileadmin.php"><button type="button"
                                                class="btn btn-light" data-dismiss="modal">Cancel</button></a><button
                                            type="button" class="btn btn-primary" data-toggle="modal"
                                            data-target="#modal-success">Save Changes</button></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="sm-menu" class="tab-pane show active" role="tabpanel" aria-labelledby="sm-menu-tab">
                            <ul class="sidebar-menu flex">
                                ...
                                <li class="sidebar-menu-item"><a class="sidebar-menu-button"
                                        href="admin_consultations.php"><i
