                        ...
                        <div class="navbar navbar-expand-sm navbar-main navbar-light bg-white  pr-0" id="navbar"
                            ...
                            <div class="container-fluid p-0">
                                <!-- Navbar toggler --><button
                                    ...
                                    href="#" class="navbar-brand flex "><span>Transactions</span></a>
                            ...
                            <ul class="nav nav-tabs nav-tabs-custom" role="tablist">
                                <li class="nav-item"><a href="#tab-queue" class="nav-link active" data-toggle="tab"
                                        role="tab" aria-controls="tab-queue" aria-selected="true"><span
                                            class="nav-link__count">Pending Transactions</span>Total (2) </a></li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active show fade" id="tab-queue">
                                        <div class="table-responsive border-bottom" data-toggle="lists"
                                            data-lists-values='["js-lists-values-employee-name", "js-lists-values-employee-title", "js-lists-values-employee-service", "js-lists-values-employee-doctor", "js-lists-values-employee-date"]'>
                                            <div class="search-form search-form--light m-3"><input type="text"
                                                    class="form-control search"
                                                    placeholder="Search Invoice ID, Amount or Patient"><button class="btn"
                                                    ...
                                                    <tr>
                                                        <th style="width: 200px;">
                                                            <a href="javascript:void(0)" class="sort"
                                                                data-sort="js-lists-values-employee-title">Invoice
                                                                ID</a>
                                                        </th>
                                                        <th colspan="1" style="width: 200px;">
                                                            <a href="javascript:void(0)" class="sort"
                                                                data-sort="js-lists-values-employee-name">Amount
                                                            </a>
                                                        </th>
                                                        <th colspan="1" style="width: 200px;">
                                                            <a href="javascript:void(0)" class="sort"
                                                                data-sort="js-lists-values-employee-date">Date
                                                            </a>
                                                        </th>
                                                        <th colspan="1" style="width: 400px;">
                                                            <a href="javascript:void(0)" class="sort"
                                                                data-sort="js-lists-values-employee-doctor">Patient
                                                            </a>
                                                        </th>
                                                        ...
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="media-body d-flex flex-column"><strong
                                                                        class="js-lists-values-employee-name">₱29,000</strong><small class="text-muted"></small>
                                                                </div>
                                                            </div>
                                                        </td>
