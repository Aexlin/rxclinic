                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6 col-xl-3">
                                                                    <div class="card property-card">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <p><a href="patient_doctordetails.php"
                                                                                    class="text-body"><strong>Neurology</strong></a>
                                                                            </p>
                                                                            <small
                                                                                class="text-dark-gray d-flex align-items-center mb-2">
                                                                                <!-- <i class="material-icons icon-16pt text-muted-light mr-1">description</i> -->
                                                                ...
                                                                <div class="col-sm-6 col-xl-3">
                                                                    <div class="card property-card">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <p><a href="patient_doctordetails.php"
                                                                                    class="text-body"><strong>Gastroenterology</strong></a>
                                                                            </p>
                                                                            <small
                                                                                class="text-dark-gray d-flex align-items-center mb-2">
                                                                                <!-- <i class="material-icons icon-16pt text-muted-light mr-1">description</i> -->
                                                                ...
                                                                <div class="col-sm-6 col-xl-3">
                                                                    <div class="card property-card">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <p><a href="patient_doctordetails.php"
                                                                                    class="text-body"><strong>Nephrology</strong></a>
                                                                            </p>
                                                                            <small
                                                                                class="text-dark-gray d-flex align-items-center mb-2">
                                                                                <!-- <i class="material-icons icon-16pt text-muted-light mr-1">description</i> -->
                                                                ...
                                                                <div class="col-sm-6 col-xl-3">
                                                                    <div class="card property-card">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <p><a href="patient_doctordetails.php"
                                                                                    class="text-body"><strong>Oncology</strong></a>
                                                                            </p>
                                                                            <small
                                                                                class="text-dark-gray d-flex align-items-center mb-2">
                                                                                <!-- <i class="material-icons icon-16pt text-muted-light mr-1">description</i> -->
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-center-title"><img class="navbar-brand-icon"
                                src="assets/img/rxcliniclogowithoutline.png" width="50" alt="Stack"><strong>Edit Doctor
                                Info</strong></h5>
                            ...
                            <form action="#">
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group"><label class="text-label" for="fname">First
                                                Name:</label><input id="fname" type="text" required=""
                                                class="form-control" placeholder="First name" value="Den"></div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group"><label class="text-label" for="lname">Middle
                                                Name:</label><input id="lname" type="text" required=""
                                                class="form-control" placeholder="Middle name" value="T"></div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group"><label class="text-label" for="lname">Last
                                                Name:</label><input id="lname" type="text" required=""
                                                class="form-control" placeholder="Last name" value="Ista"></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group"><label class="text-label" for="fname">Email
                                                Address:</label><input id="fname" type="text" required=""
                                                class="form-control" placeholder="name@gmail.com"
                                                value="drdentist_pupqc@gmail.com"></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group"><label class="text-label" for="fname">Contact
                                                No:</label><input id="fname" type="text" required=""
                                                class="form-control" placeholder="Contact No." value="0998-765-4321">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group"><label class="text-label"
                                                for="lname">Username:</label><input id="lname" type="text"
                                                class="form-control" placeholder="@username" value="@pupqcdrdentist">
                                        </div>
                                    </div>
                                </div>
                            </form>
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content bg-danger">
                    <div class="modal-body text-center p-4"><i
                        ...
                        <p class="text-white mt-3">You deleted a doctor..</p><button type="button"
                            ...
                            <form action="#">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group"><label class="text-label" for="fname">Email
                                                Address:</label><input id="fname" type="text" required=""
                                                class="form-control" placeholder="name@gmail.com" value=""></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group"><label class="text-label"
                                            ...
                                            <div class="input-group input-group-merge"><input id="password_2"
                                ...
                                <div class="modal-footer"><button type="button" class="btn btn-light"
                                        ...
                                        data-toggle="modal" data-target="#modal-add">Add Doctor</button></div>
                        </div>
                    </div><!-- // END .modal-body -->
                </div><!-- // END .modal-content -->
            </div><!-- // END .modal-dialog -->
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4"><i class="material-icons icon-40pt text-info mb-2">person</i>
                    ...
                    <p class="mt-3">You successfully added a new doctor.</p><button type="button"
                        class="btn btn-info my-2" data-dismiss="modal">Continue</button>
                </div><!-- // END .modal-body -->
            </div><!-- // END .modal-content -->
        </div><!-- // END .modal-dialog -->
    </div><!-- // END .modal -->
