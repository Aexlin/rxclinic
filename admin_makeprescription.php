...
<head>
    ...
    <title>Make Prescription - Rx Clinic </title><!-- Prevent the demo from appearing in search engines -->
                        ...
                        <div class="navbar navbar-expand-sm navbar-main navbar-light bg-white  pr-0" id="navbar"
                            ...
                            <div class="container-fluid p-0">
                                <!-- Navbar toggler --><button
                                    ...
                                    href="index.php" class="navbar-brand flex "><span>Make Prescription</span></a>
                                <div>
                                    <a href="#"><button type="button" class="btn btn-primary-dark" data-toggle="modal"
                ...
                <div
                    ...
                    <div class="container-fluid page__container">
                        <div class="card card-body">
                            ...
                            <div class="page-separator">
                                <div class="page-separator__text">PATIENT DETAILS</div>
                            </div>
                            ...
                            <form action="index.php" novalidate>
                                ...
                                <div class="modal-footer"><a href="index_patient.php"><button type="button"
                                            class="btn btn-light" data-dismiss="modal">Cancel</button></a><a
                                        href="#"><button type="button" class="btn btn-dark" data-toggle="modal"
                                            data-target="#modal-info">Print</button></a></div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content bg-danger">
                    <div class="modal-body text-center p-4"><i
                        ...
                        <p class="text-white mt-3">You deleted an patient.</p><button type="button"
                            class="btn btn-light my-2" data-dismiss="modal">Continue</button>
                    </div><!-- // END .modal-body -->
                </div><!-- // END .modal-content -->
            </div><!-- // END .modal-dialog -->
