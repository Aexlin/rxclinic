...
<html>
<head>
    <title>Declined Appointments</title>
...
<div id="loader"></div>
    ...
    <div class="col-8 py-5 container animate-bottom" style="font-family: Inter;">
        ...
        <ul class="nav nav-pills nav-fill mb-2">
            <li class="nav-item">
                <a class="nav-link" href="appointment_view.php">Pending</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="appointment_app.php">Approved</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="appointment_dec.php">Declined</a>
            </li>
        </ul>
            ...
            <tbody>
                ...
                while($row = sqlsrv_fetch_array($result)){   //Creates a loop to loop through results
                    ...
                    echo "<tr><td>" . htmlspecialchars($count) . "</td>
                        ...
                        ."<td class='d-flexbox justify-content-center text-center'>"."<a href='?changeStatus=".$status_ok,$app_id."' class='fs-5 bi-arrow-up-left-circle-fill me-4'>"."</a></td>"
            ...
            //* Update Patient Appointment (sets patient appointment status to either 2 = approved
                ...
                function changestatus($status_num, $app_id){
                    ...
                    if($status_num == 1)
                        {
                            echo '<script>
                            window.alert("Query Success, Appointment Restored");
                            ...
                            {
                                echo '<script>
                                window.alert("Query Success, Appointment Status Deleted");
                                window.location.replace("appointment_view.php");
                                </script>';
                            }
                        }
