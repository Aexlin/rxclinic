...
<head>
    ...
    <title>Admin - Rx Clinic</title><!-- Prevent the demo from appearing in search engines -->
                        ...
                        <div class="navbar navbar-expand-sm navbar-main navbar-light bg-white  pr-0" id="navbar"
                            ...
                            <div class="container-fluid p-0">
                                <!-- Navbar toggler --><button
                                    ...
                                    href="index.php" class="navbar-brand flex "><span>Dashboard</span></a>
                    ...
                    <div class="container-fluid page__container">
                        <div class="row">
                            ...
                            <div class="col-md">
                                <div class="card card-stats">
                                    <div class="d-flex align-items-center mb-2">
                                        <div class="card-header__title flex">Approved</div><a href="appointments.php">
                                            <h4 class="text-amount"><strong>17</strong></h4>
                                        </a>
                                        <!-- <span class="text-muted">&nbsp;/ $3,200</span> -->
                                    </div>
                        ...
                        <div class="row card-group-row">
                                ...
                                <div class="card card-group-row__card">
                                    <div class="card-header card-header-large bg-light d-flex align-items-center">
                                        <div class="flex">
                                            ...
                                            <div class="card-subtitle text-muted">Data of Rx Clinic Patient
                                                Segmentation</div>
                                        </div>
                                    ...
                                    <div class="card-body d-flex align-items-center justify-content-center"
                                        ...
                                        <div class="chart z-0"
                                            ...
                                            <div style="width: calc(250px - 1.25rem * 2); height: calc(250px - 1.25rem * 2); position: absolute; top: 0; left: 0;"
                                                ...
                                                <div class="text-muted mb-1">This Year</div>
                                                <div class="card-header__title">2022</div>
                                            </div>
                                    ...
                                    <div class="card-body pt-0 text-center">
                                        <div class="text-amount mb-1">719</div>
                                        <div class="text-muted">Current Total Patient Chart</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-8 col-md-7 card-group-row__col">
                                <div class="card card-group-row__card">
                                    <div class="card-header card-header-large bg-light d-flex align-items-center">
                                        <div class="flex">
                                            <h4 class="card-header__title">Patient Consultations</h4>
                                            <div class="card-subtitle text-muted">Monthly Patient Consultations 2022
                                            </div>
                                        </div>
                                        <div class="dropdown ml-auto"><a href="#" data-toggle="dropdown"
                                                data-caret="false" class="text-dark-gray"><i
                            ...
                            <div class="col-lg-7 card-group-row__col">
                                <div class="card card-group-row__card">
                                    <div class="card-header card-header-large bg-light d-flex align-items-center">
                                        ...
                                        <div class="dropdown ml-auto"><a href="#" data-toggle="dropdown"
                                                data-caret="false" class="text-dark-gray"><i
                                                    class="material-icons">more_horiz</i></a>
                                            <div class="dropdown-menu dropdown-menu-right"><a href="javascript:void(0)"
                                                    class="dropdown-item">Previous Data</a><a href="javascript:void(0)"
                                                    class="dropdown-item">Next Data</a></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body d-flex align-items-center" style="height: 250px;">
                                        <div class="chart w-100" style="height: calc(250px - 1.25rem * 2);"><canvas
                                                id="genderChart"></canvas></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card card-group-row__card">
                                    ...
                                    <div class="list-group list-group-flush">
                                        <div class="list-group-item list-group-item-action d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column flex"><strong class="text-15pt">Judell L.
                                                    Mejorada</strong><small class="text-muted">28 August 2022, 10:00
                                                    AM</small></div><i
                                        ...
                                        <div class="list-group-item list-group-item-action d-flex align-items-center">
                                            <div class="avatar avatar-sm mr-3"><img src="assets/images/profilew.png"
                                                    alt="Avatar" class="avatar-img rounded-circle"></div>
                                            <div class="d-flex flex-column flex"><strong class="text-15pt">Racquel F.
                                                    Ulibas</strong><small class="text-muted">28 August 2022, 11:00
                                                    AM</small></div><i
                                                class="material-icons icon-muted ml-3">arrow_forward</i>
                                        </div>
                                        <div class="list-group-item list-group-item-action d-flex align-items-center">
                                            ...
                                            <div
                                                ...
                                                <div class="flex">
                                                    <div class="d-flex align-items-middle">
                                                        ...
                                                        <strong class="text-15pt mr-1">Judell L. Mejorada</strong>
                                                    </div><small>Approved Appointment.</small>
                                                </div><small class="text-muted">3 days ago</small><i
                                                    class="material-icons icon-muted ml-3">arrow_forward</i>
                                            </div>
                                            <div
                                                class="list-group-item list-group-item-action d-flex align-items-center ">
                                                <div class="avatar avatar-xs mr-3"><span
                                                        class="avatar-title rounded-circle  bg-success"><i
                                                            class="material-icons">description</i></span></div>
                                                <div class="flex">
                                                    <div class="d-flex align-items-middle">
                                                        <div class="avatar avatar-xxs mr-1"><img
                                                                src="assets/images/profilew.png" alt="Avatar"
                                                                class="avatar-img rounded-circle"></div>
                                                        <strong class="text-15pt mr-1">Racquel F. Ulibas</strong>
                                                    </div><small>Gave a prescription.</small>
                                                </div><small class="text-muted">3 days ago</small><i
                                                    class="material-icons icon-muted ml-3">arrow_forward</i>
                                            </div>
                                            <div
                                                ...
                                                <div class="flex">
                                                    <div class="d-flex align-items-middle">
                                                        <div class="avatar avatar-xxs mr-1"><img
                                                                src="assets/images/jhong.jpg" alt="Avatar"
                                                                class="avatar-img rounded-circle"></div>
                                                        <strong class="text-15pt mr-1">Christine C. Positar</strong>
                                                    </div><small>Approved Appointment.</small>
                                                </div><small class="text-muted">3 days ago</small><i
                                                    class="material-icons icon-muted ml-3">arrow_forward</i>
                                            </div>
                                                ...
                                                <div class="flex">
                                                    <div class="d-flex align-items-middle">
                                                        <div class="avatar avatar-xxs mr-1"><img
                                                                src="assets/images/kkk.jpg" alt="Avatar"
                                                                class="avatar-img rounded-circle"></div>
                                                        <strong class="text-15pt mr-1">Kier A. Esteban</strong>
                                                    </div><small>Gave a prescription.</small>
                                                </div><small class="text-muted">3 days ago</small><i
                                                    class="material-icons icon-muted ml-3">arrow_forward</i>
                                            </div>
                                                ...
                                                <div class="flex">
                                                    <div class="d-flex align-items-middle">
                                                        <div class="avatar avatar-xxs mr-1"><img
                                                                src="assets/images/profilew.png" alt="Avatar"
                                                                class="avatar-img rounded-circle"></div>
                                                        <strong class="text-15pt mr-1">Angga N. Daqku</strong>
                                                    </div><small>Approved Appointment.</small>
                                                </div><small class="text-muted">3 days ago</small><i
                                                    class="material-icons icon-muted ml-3">arrow_forward</i>
                                            </div>
                                            <div class="card-footer text-center border-0"><a class="text-muted"
                                                    href="">View All (24)</a></div>
                                        </div>
                            ...
                            <div class="col-lg">
                                <div class="row card-group-row">
                                    <div class="col-lg-6 card-group-row__col">
                                        <div class="card card-group-row__card card-body card-body-x-lg"
                                            ...
                                            <div class="card-header__title text-muted mb-2">Faculty</div>
                                    ...
                                    <div class="col-lg-6 card-group-row__col">
                                        <div class="card card-group-row__card card-body card-body-x-lg"
                                            ...
                                            <div class="text-amount">694</div>
                                            <!-- <div class="text-stats text-danger">31.5% <i
                                ...
                                <div class="card">
                                    <div class="card-header card-header-large bg-white">
                                        <h4 class="card-header__title">Patient Data Segmentation</h4>
                                    </div>
                                    <div class="card-body">
                                        <ul class="list-unstyled list-skills">
                                            <li>
                                                ...
                                                <div class="text-dark-gray"><strong>14%</strong></div>
                                            </li>
                                            <li>
                                                <div>BSIT</div>
                                                <div class="flex">
                                            ...
                                            <li>
                                                ...
                                                <div class="flex">
                                                    <div class="progress" style="height: 6px;">
                                                        <div class="progress-bar bg-dark-gray" role="progressbar"
                                                            style="width: 32%;" aria-valuenow="32" aria-valuemin="0"
                                                            aria-valuemax="100"></div>
                                                    </div>
                                                </div>
                                                <div class="text-dark-gray"><strong>22%</strong></div>
                                            </li>
                                            <li>
                                                <div>BSBA-HRM</div>
                                                <div class="flex">
                                                    <div class="progress" style="height: 6px;">
                                                        <div class="progress-bar bg-danger" role="progressbar"
                                                            style="width: 10%;" aria-valuenow="28" aria-valuemin="0"
                                                            aria-valuemax="100"></div>
                                                    </div>
                                                </div>
                                                <div class="text-dark-gray"><strong>10%</strong></div>
                                            </li>
                                            <li>
                                                <div>BSBA-MM</div>
                                                <div class="flex">
                                                ...
                                                <div class="text-dark-gray"><strong>15%</strong></div>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="card-footer text-center border-0"><a href="#"><span
                                                class="text-muted">View All</span></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
